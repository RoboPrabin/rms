...
# Define date range
date_range = '2025-07-17 to 2025-10-17'

# Count order statuses and convert to single-row DataFrame
status_summary = (
    df['Order Status']
    .value_counts()
    .to_frame()
...
# Insert Date Range as the first column
status_summary.insert(0, 'Date Range', date_range)

print(status_summary)

# Export to Excel
status_summary.to_excel("report.xlsx", index=False)
